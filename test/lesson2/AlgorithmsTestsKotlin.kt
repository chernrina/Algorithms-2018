...
class AlgorithmsTestsKotlin : AbstractAlgorithmsTests() {
    ...
    fun testLongestCommonSubstring() {
        ...
        assertEquals("Алгоритмы и структуры данных", longestCommonSubstring("Алгоритмы и структуры данных",
                "Алгоритмы и структуры данных."))
        assertEquals("", longestCommonSubstring("            ", "!"))
        assertEquals("оРитм", longestCommonSubstring("АлГоРитм", "алгоРитм"))
